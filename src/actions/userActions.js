...
export const loadUser = async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/api/v1/myprofile`);
...
export const updatePassword = (formData) => async (dispatch) => {
  try {
    ...
    await axiosInstance.put(`/api/v1/password/change`, formData, config);
...
export const updateUser = (id, formData) => async (dispatch) => {
  try {
    ...
    await axiosInstance.put(`/api/v1/admin/user/${id}`, formData, config);
