...
export default function Sidebar() {
  ...
  return (
    <div>
      <Navbar expand="lg" className="bg-body-tertiary toggle-bar minwidth350">
        <Navbar.Toggle
          className="toggle-icon"
          aria-controls="basic-navbar-nav"
        />
        <Navbar.Collapse id="basic-navbar-nav toggle-sidebar">
      ...
      <div className="sidebar-wrapper filterBox1">
        <nav id="sidebar">
          <ul className="list-unstyled components">
            <li>
              <Link to="/admin/dashboard">
